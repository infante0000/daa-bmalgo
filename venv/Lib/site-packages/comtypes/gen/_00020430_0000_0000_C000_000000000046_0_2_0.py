...
IFontDisp = Font
__all__ = [ 'OLE_XSIZE_HIMETRIC', 'Picture', 'StdFont',
           'OLE_YSIZE_HIMETRIC', 'IFontEventsDisp', 'StdPicture',
           'LoadPictureConstants', 'IFontDisp', 'IFont', 'VgaColor',
           'IPicture', 'OLE_XSIZE_CONTAINER', 'OLE_XPOS_HIMETRIC',
           'FontEvents', 'OLE_XPOS_PIXELS', 'Color', 'FONTITALIC',
           'FONTUNDERSCORE', 'OLE_TRISTATE', 'OLE_YPOS_CONTAINER',
           'FONTNAME', 'OLE_XSIZE_PIXELS', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_YPOS_PIXELS', 'OLE_CANCELBOOL', 'OLE_HANDLE',
           'FONTSTRIKETHROUGH', 'IPictureDisp', 'FONTSIZE',
           'OLE_XPOS_CONTAINER', 'OLE_OPTEXCLUSIVE', 'Default',
           'OLE_YSIZE_CONTAINER', 'Checked', 'Font', 'OLE_COLOR',
           'FONTBOLD', 'Gray', 'Unchecked', 'Monochrome',
           'OLE_YSIZE_PIXELS', 'OLE_YPOS_HIMETRIC']
